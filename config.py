...
class Config(object):
    ...
    PRINT_BED_Y_SIZE = int(os.getenv("PRINT_BED_Y_SIZE", 582))
    DEFAULT_Z_ABS_HEIGHT = float(os.getenv("DEFAULT_Z_ABS_HEIGHT", 21.4)) # Default height above the z-axis to print
